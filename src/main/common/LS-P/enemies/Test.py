...
# Load the two images
image1 = cv2.imread('src\main/assets/textures\entities\characters\character_1/animations\character_1.png')
...
while True:
    ...
    overlay[new_y:new_y+masked_image.shape[0], new_x:new_x+masked_image.shape[1]] = masked_image
