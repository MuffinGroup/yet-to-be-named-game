...
int14 = textfont.render(
    "interesting tasks and much more!", True, registries.colors.BLACK
)
...
int21 = textfont.render(
    "you should learn how to move and act.", True, registries.colors.BLACK
)
...
int31 = textfont.render(
    "To walk forward press RIGHT or d", True, registries.colors.BLACK
)
...
int61 = textfont.render(
    "But of course there are some enemies.", True, registries.colors.BLACK
)
...
int71 = textfont.render(
    "If you are ready go to the door.", True, registries.colors.BLACK
)
int72 = textfont.render(
    "This door will bring you to the castle.", True, registries.colors.BLACK
)
