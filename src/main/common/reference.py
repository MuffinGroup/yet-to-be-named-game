...
screen = pygame.display.set_mode((700, 700), pygame.RESIZABLE) # initiate screen ✅

display = pygame.Surface((300, 200)) #✅


player_image = pygame.image.load("src\main/assets/textures\entities\characters\character_1/animations\character_1.png").convert_alpha() #✅
