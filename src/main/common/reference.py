...
player_image = pygame.image.load(
    "src\main/assets/textures\entities\player\standard/animations\character_standard1.png"
).convert()
player_image.set_colorkey((255, 255, 255))

grass_image = pygame.image.load(
    "src\main/assets/textures\elements\Environment\Blocks\grass_dirt.png"
)
TILE_SIZE = grass_image.get_width()

dirt_image = pygame.image.load(
    "src\main/assets/textures\elements\Environment\Blocks\Dirt.png"
)
