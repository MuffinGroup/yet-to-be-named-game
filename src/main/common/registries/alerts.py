...
class infoPanel:
    ...
    def render(self, surface, x, y,  text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, text11, text12, textColor, xOffset, yOffset):
        ...
        if self.visible == True:
            ...
            self.scaledPanel.blit(self.text6, (16 - xOffset, 176 - yOffset))
            self.scaledPanel.blit(self.text7, (16 - xOffset, 208 - yOffset))
            self.scaledPanel.blit(self.text8, (16 - xOffset, 240 - yOffset))
            self.scaledPanel.blit(self.text9, (16 - xOffset, 272 - yOffset))
            self.scaledPanel.blit(self.text10, (16 - xOffset, 304 - yOffset))
            self.scaledPanel.blit(self.text11, (16 - xOffset, 336 - yOffset))
            self.scaledPanel.blit(self.text12, (16 - xOffset, 368 - yOffset))
