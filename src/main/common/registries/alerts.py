...
class infoPanel:
    def __init__(self, panelPath, scale):
        self.visible = True
        self.font = pygame.font.Font(
            "src\main/assets/fonts\joystixmonospaceregular.otf", 15
        )
        ...
        if self.visible == True:
            ...
            surface.blit(
                ...
                (
                    ...
                    y + self.scaledIcon.get_height() * 1.57,
                ),
            )
            surface.blit(
                self.text1,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 - yOffset,
                ),
            )
            surface.blit(
                self.text2,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 1.25 - yOffset,
                ),
            )
            surface.blit(
                self.text3,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 1.5 - yOffset,
                ),
            )
            surface.blit(
                self.text4,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 1.75 - yOffset,
                ),
            )
            surface.blit(
                self.text5,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 2 - yOffset,
                ),
            )
            surface.blit(
                self.text6,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 2.25 - yOffset,
                ),
            )
            surface.blit(
                self.text7,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 2.5 - yOffset,
                ),
            )
            surface.blit(
                self.text8,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 2.75 - yOffset,
                ),
            )
            surface.blit(
                self.text9,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 3 - yOffset,
                ),
            )
            surface.blit(
                self.text10,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 3.25 - yOffset,
                ),
            )
            surface.blit(
                self.text11,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 3.5 - yOffset,
                ),
            )
            surface.blit(
                self.text12,
                (
                    x + self.scaledPanel.get_width() // 5 - xOffset,
                    y + self.scaledPanel.get_height() // 5 * 3.75 - yOffset,
                ),
            )
