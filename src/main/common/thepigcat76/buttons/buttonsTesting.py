...
test = registerButton.Button(
    "toggle", 350, 450, 12.0, "", colors.BLACK, "joystixmonospaceregular"
)
test2 = registerButton.Button(
    "toggle", 350, 150, 12.0, "", colors.BLACK, "joystixmonospaceregular"
)
