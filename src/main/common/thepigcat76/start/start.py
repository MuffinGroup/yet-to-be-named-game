...
start_button = buttons.registerButton(
    "button", 350, 250, 6.0, "start", colors.BLACK, "joystixmonospaceregular"
)
options_button = buttons.registerButton(
    "button", 350, 450, 6.0, "options", colors.BLACK, "joystixmonospaceregular"
)
quit_button = buttons.registerButton(
    "button", 350, 650, 6.0, "quit", colors.BLACK, "joystixmonospaceregular"
)
...
start_background = pygame.image.load(
    "src/main/assets/textures/elements/background/placeholder_startscreen.png"
)
...
while True:
    ...
    if start_button.drawAnimated(screen, animations.startButton, 0, 0, 6, -125, -25):
        print("Pressed Start")
    if options_button.drawAnimated(
        screen, animations.optionsButton, 48, 48, 6, -90, -25
    ):
        print("optionals")
