...
example = notification(
    "src\main/assets/textures\elements\gui/notification_bar.png",
    "src\main/assets/textures\elements\Environment\decoration\Plants\poppy.png",
    3,
    screen.get_width(),
    200,
    100,
)
examplePanel = infoPanelIcon(
    "src\main/assets/textures\elements\gui/info_panel_icon.png",
    "src\main/assets/textures\elements\Environment\decoration\Plants\poppy.png",
    8,
)
